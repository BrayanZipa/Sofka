/**
 * Clase que representa a una nave espacial no tripulada.
 * @author Brayan Zipa
 */
public class UnmannedSpaceships extends Spaceship {
    /**
     * Representa el vehículo lanzadera que va a utilizar la nave para despegar.
     */
    public ShuttleVehicles shuttle;
    /**
     * Representa la misión que va a realizar la nave espacial no tripulada.
     */
    public String mission;

    /**
     * Contructor que permite generar una instancia de la clase UnmannedSpaceships.
     * @param name
     * @param power
     * @param speed
     * @param fuel
     * @param shuttle
     */
    public UnmannedSpaceships(String name, double power, double speed, String fuel, ShuttleVehicles shuttle) {
    ...
    public void menu() {
        ...
        + "4. Exploración de Plutón\n"
        + "5. Exploración de venus\n"
        + "6. Exploración del sol";
    ...
    public String mission(int num) {
        ...
        if(num == 1){
            ...
            option = "Exploración de Júpiter";
        } else if (num == 3){
            option = "Exploración de Marte";
        } else if (num == 4){
            option = "Exploración de Plutón";
        } else if (num == 5){
            option = "Exploración de venus";
        } else if (num == 6){
            option = "Exploración del sol";
        } else {
